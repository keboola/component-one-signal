...
class NotificationsWriter(ResultWriter):
    ...
    def __init__(self, out_path, buffer=8192):
        ...
        notifications_data_tbl = KBCTableDef('notification_data', ['denikId', 'notification_id', 'url'], ['notification_id'])
        ...
        notifications_filter_tbl = KBCTableDef('notification_filters', ['field','key','notification_id','relation','value'], ['notification_id'])
